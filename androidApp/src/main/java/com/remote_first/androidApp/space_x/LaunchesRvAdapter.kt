...
class LaunchesRvAdapter(var launches: List<RocketLaunchPO>) : RecyclerView.Adapter<LaunchesRvAdapter.LaunchViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LaunchViewHolder {
        return LayoutInflater.from(parent.context)
                .inflate(R.layout.item_launch, parent, false)
                .run { LaunchViewHolder(this) }
    }
    ...
    inner class LaunchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindData(launch: RocketLaunchPO) {
            ...
            iconImageView.load("https://help.github.com/assets/images/help/profile/identicon.png")
